 ...
 * @author    Kiana Aghaei <kiana.aghaei@gmail.com>
 * @license   GPL-2.0+
 * @link      http://narenjsystem.com
 * @copyright 2016 Kiana Aghaei
 *
 * @wordpress-plugin
 * Plugin Name:       Business Hours Widget
 * Plugin URI:				http://redacademy.com
 * Description:       A custom business hours widget plugin
 * Version:           1.0.0
 * Author:            Kiana Aghaei
 * Author URI:        http://narenjsystem.com
 * License:           GPL-2.0+
	...
	public function __construct() {
		...
		parent::__construct(
			...
			array(
				...
				'description' => 'Add the business weekly hours'
			)
		);
